...
""", encoding: "UTF-8")
  ...
  post {
        aborted {
            ...
            mail to: "rxxx", subject:"Aborted: ${currentBuild.fullDisplayName}", body: "Name of the person who triggered this job - ${user_name} \n Email of the person who triggered this job - ${user_email} \n Build status - Aborted \n Job Name - ${env.JOB_NAME} \n Build Number - ${env.BUILD_NUMBER} \n Build URL - (${env.BUILD_URL}) \n"
        }
        failure {
            echo('ERROR: Build process failed')
            mail to: "xxx", subject:"Failed: ${currentBuild.fullDisplayName}", body: "Name of the person who triggered this job - ${user_name} \n Email of the person who triggered this job - ${user_email} \n Build status - Failed \n Job Name - ${env.JOB_NAME} \n Build Number - ${env.BUILD_NUMBER} \n Build URL - (${env.BUILD_URL}) \n"
        }
        success {
            echo('INFO: Build process completed successfully')
            mail to: "xxx", cc: "xxx", bcc: "rama.golla@fox.com", subject:"Success: ${currentBuild.fullDisplayName}, Branch: ${BRANCH}, Environment: ${PROJECT_ENV}, Version: ${VERSION}", body: "Name of the person who triggered this job - ${user_name} \n Email of the person who triggered this job - ${user_email} \n Build status - Success \n Job Name - ${env.JOB_NAME} \n Build Number - ${env.BUILD_NUMBER} \n Build URL - (${env.BUILD_URL}) \n"
        }
    }
} 
